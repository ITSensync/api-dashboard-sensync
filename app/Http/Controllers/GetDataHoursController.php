...
class GetDataHoursController extends Controller
{
    ...
    public function getMonthlyAveragePercentageHoursForBandungSites()
    {
        $validIds = [
            'sparing01_lap' => 'Gistex',
            'sparing03_lap' => 'PMT',
    ...
    //rata rata site sparing Indorama PWK 
    public function getMonthlyAveragePercentageHoursForIndoramaPWKSites()
    {
        $validIds = [
